...
var _playerHtml = __webpack_require__(1);
        ...
        value: function loadYoutubeAPI() {
            ...
            window.onYouTubeIframeAPIReady = function () {
                ...
                _VliteYoutube.apiReadyQueue.forEach(function (element) {
                    _this.instancePlayer = new PlayerYoutube({
