---
title: Dailymotion
description: Supports for Dailymotion player with the Dailymotion player API.
---
...
<Aside type="note">The Dailymotion API is automatically loaded by the provider.</Aside>
